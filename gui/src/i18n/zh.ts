...
export const zh: Record<TKey, string> = {
  ...
  "models.aliases.title": "模型别名",
  "models.aliases.add": "添加别名",
  "models.aliases.alias": "别名",
  "models.aliases.target": "目标（提供商/模型）",
  "models.aliases.empty": "暂无别名",
  "models.aliases.loadFailed": "无法加载模型别名。",
  "models.aliases.saveFailed": "无法保存模型别名。",
  "models.aliases.invalidAlias": "请输入不含斜杠和空格的模型 ID，且不能使用 __proto__、prototype 或 constructor。",
  "models.aliases.invalidTarget": "请使用提供商/模型格式。",
  "models.aliases.duplicate": "该别名已存在。",
  "models.aliases.edit": "编辑 {alias}",
  "models.aliases.delete": "删除 {alias}",
  "models.aliases.deleteConfirm": "确定删除别名“{alias}”吗？",

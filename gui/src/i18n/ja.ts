...
export const ja: Record<TKey, string> = {
  ...
  "models.aliases.title": "モデルエイリアス",
  "models.aliases.add": "エイリアスを追加",
  "models.aliases.alias": "エイリアス",
  "models.aliases.target": "ターゲット（プロバイダー/モデル）",
  "models.aliases.empty": "エイリアスはありません",
  "models.aliases.loadFailed": "モデルエイリアスを読み込めませんでした。",
  "models.aliases.saveFailed": "モデルエイリアスを保存できませんでした。",
  "models.aliases.invalidAlias": "スラッシュや空白を含まず、__proto__、prototype、constructor ではないモデル ID を使用してください。",
  "models.aliases.invalidTarget": "プロバイダー/モデル形式を使用してください。",
  "models.aliases.duplicate": "そのエイリアスは既に存在します。",
  "models.aliases.edit": "{alias} を編集",
  "models.aliases.delete": "{alias} を削除",
  "models.aliases.deleteConfirm": "エイリアス「{alias}」を削除しますか？",
  "models.aliases.aliasPlaceholder": "例：gpt-5.6-sol",
  "models.aliases.targetPlaceholder": "例：acode/kimi-k3",
  "models.allOn": "すべてオン",
  "models.allOff": "すべてオフ",

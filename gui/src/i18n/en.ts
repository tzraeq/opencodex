...
export const en = {
  ...
  "models.aliases.title": "Model aliases",
  "models.aliases.add": "Add alias",
  "models.aliases.alias": "Alias",
  "models.aliases.target": "Target (provider/model)",
  "models.aliases.empty": "No aliases",
  "models.aliases.loadFailed": "Could not load model aliases.",
  "models.aliases.saveFailed": "Could not save model aliases.",
  "models.aliases.invalidAlias": "Use a bare model id without slashes or spaces, and not __proto__, prototype, or constructor.",
  "models.aliases.invalidTarget": "Use provider/model format.",
  "models.aliases.duplicate": "That alias already exists.",
  "models.aliases.edit": "Edit {alias}",
  "models.aliases.delete": "Delete {alias}",
  "models.aliases.deleteConfirm": "Delete alias \"{alias}\"?",
  "models.aliases.aliasPlaceholder": "e.g. gpt-5.6-sol",
  "models.aliases.targetPlaceholder": "e.g. acode/kimi-k3",
  "models.allOn": "All on",

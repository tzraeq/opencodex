...
export const ko: Record<TKey, string> = {
  ...
  "models.aliases.title": "모델 별칭",
  "models.aliases.add": "별칭 추가",
  "models.aliases.alias": "별칭",
  "models.aliases.target": "대상(공급자/모델)",
  "models.aliases.empty": "별칭 없음",
  "models.aliases.loadFailed": "모델 별칭을 불러오지 못했습니다.",
  "models.aliases.saveFailed": "모델 별칭을 저장하지 못했습니다.",
  "models.aliases.invalidAlias": "슬래시나 공백이 없고 __proto__, prototype, constructor가 아닌 모델 ID를 사용하세요.",
  "models.aliases.invalidTarget": "공급자/모델 형식을 사용하세요.",
  "models.aliases.duplicate": "이미 존재하는 별칭입니다.",
  "models.aliases.edit": "{alias} 편집",
  "models.aliases.delete": "{alias} 삭제",
  "models.aliases.deleteConfirm": "별칭 \"{alias}\"을(를) 삭제할까요?",
  "models.aliases.aliasPlaceholder": "예: gpt-5.6-sol",
  "models.aliases.targetPlaceholder": "예: acode/kimi-k3",
  "models.allOn": "모두 켜기",
  "models.allOff": "모두 끄기",

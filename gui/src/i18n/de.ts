...
export const de: Record<TKey, string> = {
  ...
  "models.aliases.title": "Modellaliase",
  "models.aliases.add": "Alias hinzufügen",
  "models.aliases.alias": "Alias",
  "models.aliases.target": "Ziel (Anbieter/Modell)",
  "models.aliases.empty": "Keine Aliase",
  "models.aliases.loadFailed": "Modellaliase konnten nicht geladen werden.",
  "models.aliases.saveFailed": "Modellaliase konnten nicht gespeichert werden.",
  "models.aliases.invalidAlias": "Verwende eine Modell-ID ohne Schrägstriche oder Leerzeichen und nicht __proto__, prototype oder constructor.",
  "models.aliases.invalidTarget": "Verwende das Format Anbieter/Modell.",
  "models.aliases.duplicate": "Dieser Alias existiert bereits.",
  "models.aliases.edit": "{alias} bearbeiten",
  "models.aliases.delete": "{alias} löschen",
  "models.aliases.deleteConfirm": "Alias \"{alias}\" löschen?",
  "models.aliases.aliasPlaceholder": "z. B. gpt-5.6-sol",
  "models.aliases.targetPlaceholder": "z. B. acode/kimi-k3",

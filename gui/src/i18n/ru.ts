...
export const ru: Record<TKey, string> = {
  ...
  "models.aliases.title": "Псевдонимы моделей",
  "models.aliases.add": "Добавить псевдоним",
  "models.aliases.alias": "Псевдоним",
  "models.aliases.target": "Цель (провайдер/модель)",
  "models.aliases.empty": "Псевдонимов нет",
  "models.aliases.loadFailed": "Не удалось загрузить псевдонимы моделей.",
  "models.aliases.saveFailed": "Не удалось сохранить псевдонимы моделей.",
  "models.aliases.invalidAlias": "Укажите идентификатор модели без косых черт и пробелов, отличный от __proto__, prototype и constructor.",
  "models.aliases.invalidTarget": "Используйте формат провайдер/модель.",
  "models.aliases.duplicate": "Такой псевдоним уже существует.",
  "models.aliases.edit": "Изменить {alias}",
  "models.aliases.delete": "Удалить {alias}",
  "models.aliases.deleteConfirm": "Удалить псевдоним \"{alias}\"?",
  "models.aliases.aliasPlaceholder": "Например: gpt-5.6-sol",
  "models.aliases.targetPlaceholder": "Например: acode/kimi-k3",
